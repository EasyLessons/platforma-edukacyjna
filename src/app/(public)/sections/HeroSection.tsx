        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="min-w-0 flex-1 py-1">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[10px] sm:text-[11px] font-bold uppercase tracking-wider text-white/90">
                Ostatnie wydarzenie
              </p>
            </div>
        ...
        <div className="w-full max-w-[1536px] mx-auto">
          <div className="max-w-[760px] text-left flex flex-col items-start justify-end lg:hidden">
            ...
            <p className="mt-5 text-white/95 text-base sm:text-xl leading-relaxed max-w-[620px]">
              Easylesson to platforma, która łączy nowoczesne narzędzia, praktykę i wsparcie
              korepetytorów. Ucz się skutecznie, wygodnie i regularnie aż do matury.
            </p>
              ...
              <Link href="/login">
                ...
                >
                  ...
                  <span className="flex flex-col items-start leading-tight text-left">
                    <span className="text-[13px] sm:text-[15px] font-extrabold uppercase tracking-[0.04em]">
                      ZALOGUJ SIĘ Z GOOGLE
                    </span>
                    <span className="text-[11px] sm:text-[13px] font-medium normal-case text-white/95 mx-auto">
                      i wypróbuj za darmo
                    </span>
                  </span>
                </button>
              ...
              <div className="mt-8">
                <Link href="/login">
                  ...
                  >
                    ...
                    <span className="flex flex-col items-start leading-tight text-left">
                      <span className="text-[15px] font-extrabold uppercase tracking-[0.04em]">
                        ZALOGUJ SIĘ Z GOOGLE
                      </span>
                      <span className="text-[13px] font-medium normal-case text-white/95 mx-auto">
                        i wypróbuj za darmo
                      </span>
                    </span>
                  </button>
