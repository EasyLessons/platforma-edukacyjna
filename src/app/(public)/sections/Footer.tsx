...
const footerLinks = {
  produkt: [
    { label: 'Tablica', href: '/whiteboard#board' },
    { label: 'Narzędzia', href: '/whiteboard#tools' },
    { label: 'SmartSearch', href: '/whiteboard#smart-search' },
    { label: 'VoiceChat', href: '/whiteboard#voice-chat' },
    { label: 'AI Tutor', href: '/whiteboard#ai-tutor' },
    { label: 'Współbieżność', href: '/whiteboard#collaboration' },
  ...
  firma: [
    ...
    { label: 'Kontakt z działem sprzedaży', href: '/contact' },
