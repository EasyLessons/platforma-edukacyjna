...
export default function AktualnosciPage() {
  const articles = [
    ...
    },
    {
      id: 2,
      link: '/news',
      img: '/resources/news/Nauczyciel.jpg',
    ...
    },
    {
      id: 3,
      link: '/news',
      img: '/resources/news/Wspolbieznosc.jpg',
      ...
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="mb-12 text-center md:text-left">
          ...
          <p className="text-xl text-gray-600 max-w-2xl">
            Najnowiej wprowadzone funkcje platformy i najświeższe opublikowane dla Was materiały i
            ulepszenia
          </p>
        </div>
