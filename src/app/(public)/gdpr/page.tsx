      ...
      <main className="flex-grow max-w-4xl mx-auto px-6 py-24 pb-40 w-full z-10">
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-gray-100">
          <div className="prose prose-lg max-w-none text-gray-600 prose-headings:text-[#212224] prose-a:text-[#212224]">
            ...
            <p>
              We wszelkich sprawach związanych z danymi osobowymi i ich ochroną możesz skontaktować się z nami pisząc na adres e-mail: <strong>kontakt@easylesson.pl</strong> lub korzystając z naszego <a href="/contact">formularza kontaktowego</a>.
            </p>
