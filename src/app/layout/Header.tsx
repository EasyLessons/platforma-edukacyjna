              ...
              {isLoggedIn ? (
                <Link href="/dashboard">
                  <button
                    ...
                    style={{ backgroundColor: '#EEF0F3', color: '#111827' }}
                  >
                    Panel
                  </button>
                </Link>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                Kontakt z działem sprzedaży
                <svg
                  className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transform group-hover:translate-x-0.5 transition-all duration-300"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
              ...
              {isLoggedIn ? (
                <>
                  {user && (
                    <span className={`text-sm px-2 transition-colors ${isHeroSectionActive ? 'text-white' : 'text-gray-600'}`}>
                      Witaj, <strong className={isHeroSectionActive ? 'text-white' : 'text-black'}>{user.username}</strong>!
                    </span>
                  )}
                  <Link href="/dashboard">
              ...
              >
                <div className="max-w-[1400px] mx-auto px-6 pb-8">
                  <div className="grid grid-cols-12 gap-8 pt-8">
                    ...
                    {/* Kolumna 3 - Poradnik */}
                    <div
                      className="col-span-6 animate-fadeInUp"
                  ...
                  <div className="border-t border-gray-200 mt-8 pt-6 animate-newsletterFadeIn">
                    <div className="grid grid-cols-12 gap-8 items-center">
                      <div className="col-span-5">
                        <h3
                          className="text-2xl font-playfair italic text-gray-900 mb-2"
                          style={{ fontFamily: 'var(--font-playfair)' }}
                        >
                          Dołącz do naszej społeczności
                        </h3>
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Otrzymuj wiadomości o nowych funkcjach, poradnikach i najlepszych
                          praktykach w edukacji online.
                        </p>
                      </div>
                ...
                <div className="max-w-[1400px] mx-auto px-6 pb-8">
                  <div className="grid grid-cols-12 gap-8 pt-8">
                    ...
                    <div className="col-span-6 animate-fadeInUp" style={{ animationDelay: '0ms' }}>
                      ...
                      <div
                        className="mt-6 bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200 rounded-xl p-5 animate-fadeInUp"
                        style={{ animationDelay: '100ms' }}
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 leading-relaxed">
                              Tworzone przez korepetytorów z wieloletnim doświadczeniem.
                              Profesjonalne filmy w łatwej i ładnej formie video.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="border-t border-gray-200 mt-8 pt-6 animate-newsletterFadeIn">
                    <div className="grid grid-cols-12 gap-8 items-center">
                      <div className="col-span-5">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Dowiedz się jako pierwszy o nowych kursach, materiałach i funkcjach
                          platformy.
                        </p>
                      </div>
                      <div className="col-span-7">
                        ...
                        <div className="flex items-start gap-2 mt-3">
                          <input
                            type="checkbox"
                            id="courses-newsletter-privacy"
                            className="mt-0.5 cursor-pointer"
                          />
                          <label
                            htmlFor="courses-newsletter-privacy"
                            className="text-xs text-gray-600 cursor-pointer"
                          >
                            Akceptuję{' '}
                            <a href="#" className="text-blue-600 hover:underline">
                ...
                <div className="max-w-[1400px] mx-auto px-6 pb-8">
                  <div className="grid grid-cols-12 gap-8 pt-8">
                    ...
                    <div className="col-span-4 animate-fadeInUp" style={{ animationDelay: '0ms' }}>
                      ...
                      <p className="text-gray-600 text-sm mt-3 leading-snug">
                        Zobacz co czeka się w planie premium i dlaczego warto zainwestować w lepsze
                        narzędzia do nauki!
                      </p>
                    </div>
                    ...
                    <div
                      className="col-span-4 animate-fadeInUp"
                      style={{ animationDelay: '100ms' }}
                    >
                      <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4">
                        &nbsp;
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden mb-5">
                        <table className="w-full text-sm table-fixed">
                          ...
                          <tbody className="divide-y divide-gray-200">
                            <tr className="hover:bg-gray-50 transition-colors h-14">
                              <td className="px-4 py-3 text-gray-700 h-14">
                  ...
                  <div className="border-t border-gray-200 mt-8 pt-6 animate-newsletterFadeIn">
                    <div className="grid grid-cols-12 gap-8 items-center">
                      <div className="col-span-5">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Darmowe miesiące, zniżki dla nauczycieli i ekskluzywne promocje - tylko
                          dla subskrybentów.
                        </p>
                      </div>
                      <div className="col-span-7">
                        ...
                        <div className="flex items-start gap-2 mt-3">
                          <input
                            type="checkbox"
                            id="pricing-newsletter-privacy"
                            className="mt-0.5 cursor-pointer"
                          />
                          <label
                            htmlFor="pricing-newsletter-privacy"
                            className="text-xs text-gray-600 cursor-pointer"
                          >
                            Akceptuję{' '}
                            <a href="#" className="text-blue-600 hover:underline">
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <p className="text-sm text-gray-600 line-clamp-2">
                          Dodaliśmy nowy kalkulator naukowy, rysowanie funkcji matematycznych i
                          zaawansowany edytor równań. Idealne dla nauczycieli matematyki!
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <p className="text-sm text-gray-600 line-clamp-2">
                          Ulepszyliśmy algorytm AI Tutora! Teraz jeszcze lepiej rozumie kontekst
                          pytań i udziela bardziej szczegółowych odpowiedzi.
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <p className="text-sm text-gray-600 line-clamp-2">
                          Zwiększyliśmy limit współpracy realtime! Teraz w planie Premium do 50 osób
                          może pracować jednocześnie na tablicy.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-gray-200 mt-8 pt-6 animate-newsletterFadeIn">
                    <div className="grid grid-cols-12 gap-8 items-center">
                      <div className="col-span-5">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Najświeższe aktualizacje, nowe funkcje i case studies od naszej
                      ...
                      <div className="col-span-7">
                        ...
                        <div className="flex items-start gap-2 mt-3">
                          <input
                            type="checkbox"
                            id="news-newsletter-privacy"
                            className="mt-0.5 cursor-pointer"
                          />
                          <label
                            htmlFor="news-newsletter-privacy"
                            className="text-xs text-gray-600 cursor-pointer"
                          >
                            Akceptuję{' '}
                            <a href="#" className="text-blue-600 hover:underline">
