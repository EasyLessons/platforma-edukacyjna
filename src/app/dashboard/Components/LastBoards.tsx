...
export default function LastBoards() {
    ...
    return (
      <>
        ...
        <div className="flex items-center justify-between mb-4 md:mb-6">
          <div className="h-6 md:h-8 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded animate-shimmer bg-[length:200%_100%] w-48 md:w-64"></div>
          <div className="h-8 md:h-10 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded animate-shimmer bg-[length:200%_100%] w-20 md:w-24"></div>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-3 md:p-4 mb-4 md:mb-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-6">
            <div className="flex items-center gap-2">
              ...
              <div className="h-4 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded animate-shimmer bg-[length:200%_100%] w-32"></div>
            </div>
            <div className="flex gap-2 sm:gap-4 sm:ml-auto">
              <div className="h-8 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded-lg animate-shimmer bg-[length:200%_100%] w-32"></div>
              <div className="h-8 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded-lg animate-shimmer bg-[length:200%_100%] w-36"></div>
            </div>
          </div>
        </div>

        {/* Nagłówki kolumn skeleton - tylko desktop */}
        <div className="hidden lg:grid grid-cols-12 gap-4 px-2 mb-3">
          <div className="col-span-4 h-3 bg-gray-300 rounded animate-pulse"></div>
          <div className="col-span-2 h-3 bg-gray-300 rounded animate-pulse"></div>
          <div className="col-span-2 h-3 bg-gray-300 rounded animate-pulse"></div>
          <div className="col-span-2 h-3 bg-gray-300 rounded animate-pulse"></div>
        </div>
              ...
              <div className="lg:hidden">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-3 flex-1">
                    <div className="w-10 h-10 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded-lg animate-shimmer bg-[length:200%_100%]"></div>
                    <div className="h-4 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded animate-shimmer bg-[length:200%_100%] flex-1 max-w-40"></div>
                  </div>
                  <div className="flex gap-1">
                    <div className="w-7 h-7 bg-gray-300 rounded-lg animate-pulse"></div>
                    <div className="w-7 h-7 bg-gray-300 rounded-lg animate-pulse"></div>
                  </div>
                </div>
              ...
              <div className="hidden lg:grid grid-cols-12 gap-4 items-center">
                <div className="col-span-4 flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="h-4 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded animate-shimmer bg-[length:200%_100%] w-3/4 mb-1"></div>
                ...
                <div className="col-span-2 text-center">
                  <div className="h-4 bg-gray-300 rounded animate-pulse w-8 mx-auto"></div>
                </div>
  ...
  return (
    <>
      ...
      <div className="hidden lg:grid grid-cols-12 gap-4 px-3 mb-3 text-xs font-semibold text-gray-700 uppercase tracking-wider">
      ...
      {/* Lista tablic */}
      <div className="space-y-2 md:space-y-3 overflow-visible px-1">
        {filteredBoards.length === 0 ? (
          <div className="text-center py-12 md:py-16 bg-gray-50 rounded-xl">
            <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-4 bg-gradient-to-br from-green-100 to-green-200 rounded-full flex items-center justify-center">
              <Rocket size={24} className="md:w-9 md:h-9 text-green-600" />
            </div>
            <p className="text-base md:text-lg font-medium text-gray-800 mb-1">Brak tablic</p>
            <p className="text-xs md:text-sm text-gray-600">Utwórz nową, aby zacząć!</p>
          </div>
        ) : (
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0">
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded-lg text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-all duration-200 cursor-pointer ${openDropdownId === board.id ? 'bg-gray-100 text-gray-700' : ''}`}
                      >
                ...
                <div className="hidden lg:grid grid-cols-12 gap-4 items-center">
                  ...
                  <div className="col-span-2">
                    <div className="flex items-center gap-1.5 text-sm">
                      ...
                      <span className="font-medium text-gray-800 truncate">{board.lastOpened}</span>
                    </div>
                  </div>
                  ...
                  <div className="col-span-2">
                    <div className="flex items-center gap-1.5 text-sm">
                      ...
                      <span className="font-medium text-gray-800 truncate">{board.owner}</span>
                    </div>
                  </div>
                  ...
                  <div className="col-span-1 flex justify-end">
                    <button
                      ...
                      className={`p-2 rounded-xl text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-all duration-200 cursor-pointer ${openDropdownId === board.id ? 'opacity-100 bg-gray-100 text-gray-700' : 'opacity-0 group-hover:opacity-100'}`}
                    >
