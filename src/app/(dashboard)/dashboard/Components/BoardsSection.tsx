...
export default function BoardsSection({
  ...
  const handleSelect = (boardId: number, boardWorkspaceId?: number) => {
    ...
    const workspaceParam = boardWorkspaceId ?? workspace_id;
    router.push(`/whiteboard?boardId=${boardId}&workspace=${workspaceParam}`);
  };
    ...
    <>
      ...
      >
        <div className="pt-4">
          ...
          <div className="hidden lg:grid grid-cols-12 gap-4 px-5 pb-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">
