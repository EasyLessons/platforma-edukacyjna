          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="min-w-0 flex-1 py-1">
              <div className="flex items-center gap-2">
                ...
                <p className="text-[10px] sm:text-[11px] font-bold uppercase tracking-wider text-white/90">Nadchodzące wydarzenie</p>
              </div>
        ...
        <div className="absolute inset-0 z-10 px-6 sm:px-12 lg:px-20 xl:px-28 pb-16 sm:pb-24 lg:pb-32 pt-24 sm:pt-28 flex items-end">
          <div className="w-full max-w-[1536px] mx-auto">
            <div className="max-w-[760px] text-left flex flex-col items-start justify-end lg:hidden">
              ...
              >
                <span className="block">Jedna tablica. Milion</span>
              ...
              <div className="mt-7">
                <Link href="/login">
                  <button
                    type="button"
                    className="group relative cursor-pointer inline-flex items-center gap-3.5 rounded-xl bg-green-500 text-white font-bold px-6 sm:px-7 py-3.5 sm:py-4 ring-1 ring-green-400/50 hover:bg-green-400 transition-colors duration-200 hover:scale-[1.02] shadow-lg shadow-green-500/20"
                  >
