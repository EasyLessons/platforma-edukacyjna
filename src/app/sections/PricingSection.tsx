...
export default function PricingSection() {
  return (
    <section id="pricing" className="relative bg-[#f5f3ef] overflow-hidden py-20 px-4">
      {/* SIATKA KROPEK W TLE */}
      <div
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="relative max-w-screen-2xl mx-auto h-full">
          ...
          <div
            className="absolute left-[8%] top-[20%] animate-bounce"
            style={{ animationDuration: '3s' }}
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path
                d="M3 3 L10 20 L12 12 L20 10 Z"
                fill="#3b82f6"
                stroke="#1e40af"
                strokeWidth="1.5"
              />
          ...
          <div
            className="absolute right-[6%] top-[38%] animate-bounce"
          ...
          <div
            className="absolute left-[10%] bottom-[28%] animate-bounce"
          ...
          <div
            className="absolute right-[8%] top-[24%] animate-bounce"
          ...
          <div
            className="absolute left-[6%] bottom-[42%] animate-bounce"
          ...
          <div
            className="absolute right-[7%] bottom-[32%] animate-bounce"
          ...
          <div
            className="absolute left-[5%] top-[28%] animate-bounce"
            style={{ animationDuration: '2.9s', animationDelay: '0.2s' }}
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path
                d="M3 3 L10 20 L12 12 L20 10 Z"
          ...
          <div
            className="absolute right-[9%] top-[48%] animate-bounce"
      ...
      <div className="relative max-w-6xl mx-auto z-10">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-6">
                    <div className="flex items-baseline gap-2">
                      ...
                      <span className="text-xl text-gray-600">{plan.priceDetail}</span>
                    </div>
                    {plan.name === 'PRO' && (
                      <p className="text-sm text-gray-500 mt-2">lub €10/mies. płatne rocznie</p>
                    )}
                  </div>
                  ...
                  <ul className="space-y-3 mb-8">
                    {plan.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        ...
                        <span
                          className={`text-base ${feature.included ? 'text-gray-700' : 'text-gray-400'}`}
                        >
                          {feature.text}
                        </span>
                      </li>
                ...
                <tbody>
                  {comparisonFeatures.map((feature, idx) => (
                    ...
                    >
                      ...
                      <td className="p-4 text-center text-gray-900 font-semibold bg-green-50/50">
                        {feature.pro}
                      </td>
                    </tr>
                  ))}
        ...
        <div className="text-center mt-16">
          <p className="text-2xl font-bold text-gray-900 mb-4">Gotowy żeby zacząć? 🚀</p>
          <Link href="/register">
