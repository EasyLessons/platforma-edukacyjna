 ...
 * BOARD ICON PICKER
 *
 * Komponent pozwalający użytkownikowi wybrać ikonę dla tablicy.
...
import { BOARD_ICONS, BOARD_ICON_NAMES } from '../utils/constants';
  ...
  return (
    <div>
      ...
      <p className="text-xs text-gray-500 mt-2">
        Wybierz ikonę która najlepiej opisuje Twoją tablicę
      </p>
    </div>
  );
}
