...
function MathChatbotInner({
  ...
  className="relative rounded-2xl cursor-pointer transition-all duration-300 hover:scale-105"
  style={{
    padding: '1px',
...
>
  ...
  <div 
    className="relative bg-gradient-to-br from-slate-900 via-slate-950 to-black rounded-2xl px-6 py-4 overflow-hidden"
  >
    ...
    <div className="relative flex items-center gap-2">
      ...
      <svg 
        ...
        className="w-5 h-5 drop-shadow-[0_0_4px_rgba(147,112,219,0.3)]"
      >
        <path 
          fill="url(#aiGradient)" 
      ...
      {/* Tekst z gradientem */}
      <span className="text-transparent bg-clip-text bg-gradient-to-b from-violet-100/70 via-purple-100 to-violet-400 font-semibold text-base">
        Tutor AI
      </span>
    </div>
  </div>
