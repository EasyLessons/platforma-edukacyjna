...
15. **`docs/security/AUDYT-2026-09.md`** — audyt bezpieczeństwa (znaleziska SEC-xx z dowodami `plik:linia`, plan PR-ów naprawczych, akcje dla Patryka). Obok: `rls-board-images.sql` i `rls-realtime.sql` — gotowe polityki do uruchomienia w Supabase SQL Editor.
